...
from QA_base.sentence import Sentence
from collections import defaultdict
from QA_base.model import *
...
class SentenceSimilarity():
    ...
    def TfidfModel(self):
        ...
        # 创建相似度矩阵
        self.index = similarities.MatrixSimilarity(self.corpus, len(self.dictionary))
    ...
    def Bm25Model(self):
        ...
        self.model = BM25Model(self.corpus_simple, self.texts)
        self.corpus = self.model[self.corpus_simple]
